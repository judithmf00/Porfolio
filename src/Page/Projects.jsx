    ...
    <>
      ...
      <section className='containerProjects'>
        <article className='project'>
          <h4 className='text-xl font-semibold mb-2'>Contador de calorías <span className='italic font-mono text-sm text-red-500'>(En desarrollo)</span></h4>
          ...
          <div className="buttonsProjects">
            <a href="https://github.com/judithmf00/contadorCalorias" target="_blank"><i className="fab fa-github" style={{ color: '#fefefe' }}></i></a>
            <a href="https://www.figma.com/proto/xHFD15IQqfLJLGCjN4ls7e/Contador-de-calorias?node-id=1-2&node-type=canvas&t=lpBryj9nEVgNZUra-1&scaling=contain&content-scaling=fixed&page-id=0%3A1" target="_blank"><i className="fab fa-figma" style={{ color: '#fefefe' }}></i></a>
          </div>
        ...
        <article className='project'>
          ...
          <div className="buttonsProjects">
            <a href="https://github.com/judithmf00/calculadoraComandas" target="_blank"><i className="fab fa-github" style={{ color: '#fefefe' }}></i></a>
            <a href="https://www.figma.com/proto/pCDgqQQl6wuH9pM372ujxc/Calculadora-comandas?t=GLPD6Q2KJzBRKzHa-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&node-id=1-2" target="_blank"><i className="fab fa-figma" style={{ color: '#fefefe' }}></i></a>
          </div>
        </article>
        <article className='project'>
        ...
        <article className='project'>
          ...
          <div className="buttonsProjects">
            <a href="https://github.com/judithmf00/coctelesJavascriptApi" target='_black'><i className="fab fa-github" style={{ color: '#fefefe' }}></i></a>
          </div>
        </article>
        <article className='project'>
          ...
          <div className="buttonsProjects">
            <a href="https://github.com/judithmf00/shopGuitar" target='_black'><i className="fab fa-github" style={{ color: '#fefefe' }}></i></a>
            <a href="https://www.figma.com/proto/h4SC1UHcyWvel2gHOoX7sg/Shop-Guitar?node-id=1-2&t=4g9z4EyVwLwSCzUG-1" target='_black'><i className="fab fa-figma" style={{ color: '#fefefe' }}></i></a>
          </div>
        </article>
      </section>
    </>
